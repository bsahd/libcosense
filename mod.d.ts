...
declare class CosenseClient implements CosenseClientopts {
    ...
    alternativeFetch?: (input: RequestInfo | URL, init?: RequestInit) => Promise<Response>;
    urlbase: string;
    /**
...
declare class Project {
     ...
     */
    static useClient(projectName: string, client: CosenseClient): Promise<Project>;
    private constructor();
    /**
...
export type { Collaborator, CosenseClientopts, LatestPages, LatestPagesInit, LatestPagesPage, Member, Page, PageLine, PageListItem, RelatedPage, RelatedPages, SearchResult, SearchResultPage, Project };
